    ...
    <Card className="w-full shadow-xl bg-card/80 backdrop-blur-sm">
      ...
      <CardFooter className="flex flex-col gap-4 pt-6">
          ...
          <div className="grid grid-cols-2 gap-3 w-full">
              <Button variant="destructive" onClick={handleClearSelection} className="h-11 text-base shadow-md" disabled={currentPicks.length === 0}>
                  <Trash2 className="mr-2 h-4 w-4" /> Limpar
              </Button>
              <Button variant="outline" onClick={handleAutoFill} className="h-11 text-base shadow-sm">

    ...
    return (
      <aside
        ...
        className={cn(
            ...
            state === 'collapsed' && collapsible === 'offcanvas' && 'w-0 border-none',
            className
        )}
        data-state={state}
        {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <hr
      ...
      className={cn("mx-2 my-2 border-t border-sidebar-border", className)}
      {...props}
    />
  )
})
